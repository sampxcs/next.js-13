...
export default function Page () {
  return (
    <header className='flex justify-between items-center sticky backdrop-blur-lg top-0 z-40 py-4 px-8 max-w-screen-2xl -mt-1 mx-auto border-b-[1px]  bg-white bg-opacity-80 dark:bg-opacity-20 dark:bg-neutral-950 dark:border-neutral-900'>
